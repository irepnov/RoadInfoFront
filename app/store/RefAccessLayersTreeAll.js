Ext.define('roadInfo.model.RefAccessLayersTreeAll', {
...
Ext.define('roadInfo.store.RefAccessLayersTreeAll', {
    extend: 'Ext.data.TreeStore',
    alias: 'store.RefAccessLayersTreeAll',
    model: 'roadInfo.model.RefAccessLayersTreeAll',
    /*root: {
        text: 'Все разделы',
        expanded: false,
       // iconCls: 'dorgis16',
    ...
    proxy: {
        type: 'ajax',
        url: ProxyUrlBackend + '/roadinfo/layers/?foruser=0',
