var PolylineOffset = {
    ...
    offsetPointLine: function (points, distance) {
        ...
        this.forEachPair(points,function (a, b) {
            if (a.x === b.x && a.y === b.y) {
                return;
            }
            ...
            offsetSegments.push({
                ...
                original: [a, b],
                offset: [
                    me.translatePoint(a, distance, offsetAngle),
                    me.translatePoint(b, distance, offsetAngle)
                ]
            });
        });
    ...
    offsetPoints: function (pts, offset) {
        ...
        var j = this.joinLineSegments(offsetSegments, offset);
        return j;
    },
    ...
    joinLineSegments: function (segments, offset) {
        ...
        if (first && last) {
            ...
            this.forEachPair(segments, function (s1, s2) {
                joinedPoints = joinedPoints.concat(me.joinSegments(s1, s2, offset));
            });
